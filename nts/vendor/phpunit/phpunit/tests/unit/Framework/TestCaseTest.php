...
class TestCaseTest extends TestCase
{
    ...
    public function testSkipped(): void
    {
        ...
        $this->assertEquals('Skipped tests', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
    ...
    public function testIncomplete(): void
    {
        ...
        $this->assertEquals('Incomplete tests', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
        $this->assertEquals(0, $result->skippedCount());
        $this->assertCount(1, $result);
    ...
    public function testRequiringASetting(): void
    {
        ...
        // Get this so we can return it to whatever it was before the tests.
