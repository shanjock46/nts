...
class TestTest extends TestCase
{
    ...
    /**
     * @testdox Test::getRequirements() for $tests
    ...
    /**
     * @testdox Test::getRequirements() with constraints for $tests
    ...
    /**
     * @testdox Test::getMissingRequirements() for $tests
    ...
    /**
     * @todo This tests does not really tests functionality of \PHPUnit\Util\Test
     */
    ...
    {
        $dataSets = Test::getProvidedData(\VariousIterableDataProviderTest::class, 'tests');
    ...
    public function testWithDuplicateKeyDataProviders(): void
    {
        ...
        Test::getProvidedData(\DuplicateKeyDataProviderTest::class, 'tests');
    }
