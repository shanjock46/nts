...
abstract class TestCase extends Assert implements Test, SelfDescribing
{
    ...
    /**
     * Returns a tests double for the specified class.
     *
    ...
    /**
     * Returns a configured tests double for the specified class.
     *
     * @param string|string[] $originalClassName
     *
     * @throws \ReflectionException
    ...
    /**
     * Returns a partial tests double for the specified class.
     *
     * @param string|string[] $originalClassName
    ...
    private function setExpectedExceptionFromAnnotation(): void
    {
        ...
        try {
            ...
            if ($expectedException !== false) {
                $this->addWarning('The @expectedException, @expectedExceptionCode, @expectedExceptionMessage, and @expectedExceptionMessageRegExp annotations are deprecated. They will be removed in PHPUnit 9. Refactor your tests to use expectException(), expectExceptionCode(), expectExceptionMessage(), or expectExceptionMessageRegExp() instead.');
