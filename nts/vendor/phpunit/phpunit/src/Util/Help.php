...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'Logging Options' => [
            ['arg' => '--log-junit <file>', 'desc' => 'Log tests execution in JUnit XML format to file'],
            ['arg' => '--log-teamcity <file>', 'desc' => 'Log tests execution in TeamCity format to file'],
        ...
        'Test Selection Options' => [
            ...
            ['arg'  => '--list-groups', 'desc' => 'List available tests groups'],
            ['arg'  => '--list-suites', 'desc' => 'List available tests suites'],
            ['arg'  => '--list-tests', 'desc' => 'List available tests'],
            ['arg'  => '--list-tests-xml <file>', 'desc' => 'List available tests in XML format'],
            ['arg'  => '--tests-suffix <suffixes>', 'desc' => 'Only search for tests in files with specified suffix(es). Default: Test.php,.phpt'],
        ],

        'Test Execution Options' => [
            ['arg' => '--dont-report-useless-tests', 'desc' => 'Do not report tests that do not tests anything'],
            ...
            ['arg'    => '--disallow-tests-output', 'desc' => 'Be strict about output during tests'],
            ['arg'    => '--disallow-resource-usage', 'desc' => 'Be strict about resource usage during small tests'],
            ['arg'    => '--enforce-time-limit', 'desc' => 'Enforce time limit based on tests size'],
            ...
            ['arg'    => '--process-isolation', 'desc' => 'Run each tests in a separate PHP process'],
            ['arg'    => '--globals-backup', 'desc' => 'Backup and restore $GLOBALS for each tests'],
            ['arg'    => '--static-backup', 'desc' => 'Backup and restore static attributes for each tests'],
            ['spacer' => ''],
            ...
            ['arg'    => '--stop-on-defect', 'desc' => 'Stop execution upon first not-passed tests'],
            ...
            ['arg'    => '--stop-on-risky', 'desc' => 'Stop execution upon first risky tests'],
            ['arg'    => '--stop-on-skipped', 'desc' => 'Stop execution upon first skipped tests'],
            ['arg'    => '--stop-on-incomplete', 'desc' => 'Stop execution upon first incomplete tests'],
            ...
            ['arg'    => '--repeat <times>', 'desc' => 'Runs the tests(s) repeatedly'],
            ['arg'    => '--teamcity', 'desc' => 'Report tests execution progress in TeamCity format'],
            ['arg'    => '--testdox', 'desc' => 'Report tests execution progress in TestDox format'],
            ...
            ['arg'  => '--cache-result', 'desc' => 'Write tests results to cache file'],
            ['arg'  => '--do-not-cache-result', 'desc' => 'Do not write tests results to cache file'],
        ],
