...
class TestDoxPrinter extends ResultPrinter
{
    ...
    /**
     * @var int The number of tests results received from the TestRunner
     */
    protected $testIndex = 0;

    /**
     * @var int The number of tests results already sent to the output
     */
    protected $testFlushIndex = 0;

    /**
     * @var array<int, array> Buffer for tests results
     */
