...
final class TestSuiteSorter
{
    ...
    /**
     * List of sorting weights for all tests result codes. A higher number gives higher priority.
     */
    ...
    /**
     * Compares tests duration for sorting tests by duration ascending.
     *
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
     ...
     * For more details see the documentation for tests dependencies.
     *
     * Short description of algorithm:
     * 1. Pick the next Test from remaining tests to be checked for dependencies.
     * 2. If the tests has no dependencies: mark done, start again from the top
     * 3. If the tests has dependencies but none left to do: mark done, start again from the top
     ...
     *
     * @return array<string> A list of full tests names as "TestSuiteClassName::testMethodName"
     */
